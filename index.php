        ...
        <div class="carousel-inner" style="height: 650px;">
          <div class="carousel-item active">
            ...
            <div class=" carousel-caption d-md-block p-5" style="top: 32%; bottom: auto;">
              <h1 class="text-uppercase">Your dream vacation start</h1>
      ...
      <div class="container-fluid">
        ...
        <div class="col-md-11 container-fluid font-card-tengah justify-content-center">
          ...
          <div class="row row-cols-2 row-cols-md-5 g-0">
            ...
            ?>
              <div class="col g-4">
                <div class="card h-100 shadow zoom-effect">
                  <div class="overflow-hidden" style="min-height: 27vw; max-height: 27vw;">
                    <img src="<?= $row['image_url'] ?>" class=" rounded-top h-100 w-100 object-fit-cover" alt="assets/bromo.webp">
                  </div>

                  <div class="card-body pb-2">
                    <h6 class="card-title"><?= $row['destination_name'] ?></h6>
                    <p class="card-text"><?= $row['description'] ?></p>
                    <a href="./tour/destinasi.php?id=<?= $row['destination_id'] ?>" class="stretched-link"> </a>
                  </div>
                </div>
              </div>
            <?php endwhile ?>
            ...
            ?>
              <div class="card mb-4 mx-auto shadow" style="max-width: 543px; ">
                <div class="row g-0 w-100 h-100">
                  <div class="col-md-4">
                    <img src="<?= str_replace("..", ".", $row['image_url']) ?>" class="rounded-start h-100 w-100 object-fit-cover d-block" style="height: auto;" alt="...">
                  </div>
        ...
        <div class="container-fluid col-md-11 mt-5 justify-content-center">
          ...
          <div class="row row-cols-1 row g-0 ">
            <?php
            $hasil_t = mysqli_query($conn, "SELECT * FROM articles ORDER BY article_id DESC");
            $count = 0; // Variabel hitung
            while ($row = mysqli_fetch_array($hasil_t)) :
            ?>
              <div class="card mb-3 shadow" style="width: 90vw;">
                <div class="row g-0 ">
                  <div class="col-md-4">
                    <img src="<?= str_replace("..", ".", $row['image_url']) ?>" class="h-100 w-100 rounded-start object-fit-cover object-position-center center" style="max-height: 300px;" alt="...">
                  </div>
                  <div class="col-md-8">
            ...
            <div class="m-auto mb-5 mt-5">
              <button class="btn btn-dark btn-lg">
                <a href="./artikel/" class=" text-decoration-none text-white">See More</a>
              </button>
            </div>
          </div>
        </div>
